...
- ODD设计运行域分析器 - 四维度边界监测、可观性/可控性评估、自主等级判定
- 设备配置自动提取器 - 从传感器/执行器实例自动推导ODD边界
- YCJL专用ODD构建器 - 引绰济辽工程特有约束与冰期模式
- [NEW] 传感器点位与参数优化模块 - 自动优化传感器布置，支持多目标优化
- [NEW] 可观测性/成本效益/鲁棒性分析器
...
- core: 通用核心框架（插值器、物理基类、仿真基类、调度基类、数据诊断基类、ODD分析器、传感器优化器）
"""
